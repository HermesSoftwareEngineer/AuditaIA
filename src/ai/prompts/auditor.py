...
PROMPT 1 - Quando o usuário solicitar informações sobre um repasse relacionado a um locador, siga os passos:
...
PROMPT 2 - Quando o usuário solicitar os imóveis vinculados a um locador, siga os passos:
...
PROMPT 3 - Quando o usuário solicitar os contratos vinculados a um locador, siga os passos:
...
PROMPT 4 - Quando o usuário solicitar os contratos vinculados a um locatário, siga os passos:
